...
#             <openid-config url="https://ltf-id-8605-dev.azurewebsites.net/.well-known/openid-configuration" />
#             <required-claims>
...
#   ]
#   import {
#     content_format = var.swagger-json
#     content_value  = var.swagger-json-url // a file reference example: ("${path.module}/api.yaml")
#   }
# }
